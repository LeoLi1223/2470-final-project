...
from model_utils import get_embedding_matrix
...
class TransformerDecoder(tf.keras.Model):
    ...
    def __init__(self, vocab_size, hidden_size, window_size, word2idx, **kwargs):
        ...
        self.embedding_matrix = get_embedding_matrix(word2idx)
    ...
    def call(self, encoded_images, captions):
        ...
        decoded = self.decoder(captions, encoded_images)
        # print(decoded.shape)
        logits = self.classifier(decoded) # aka probs
        # print(logits.shape)
        # print()
        return logits
